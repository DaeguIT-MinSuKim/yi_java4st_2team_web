...
-- 차량 분류
INSERT INTO KIND(KIND_NAME, KIND_FARE) VALUES ('소형', 60000);
INSERT INTO KIND(KIND_NAME, KIND_FARE) VALUES ('중형', 70000);
INSERT INTO KIND(KIND_NAME, KIND_FARE) VALUES ('대형', 100000);
INSERT INTO KIND(KIND_NAME, KIND_FARE) VALUES ('승합', 120000);
INSERT INTO KIND(KIND_NAME, KIND_FARE) VALUES ('수입', 250000);
SELECT * FROM KIND;

-- 브랜드 분류
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('기아', 'kia.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('현대', 'hyundai.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('쉐보레', 'che.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('르노삼성', 'renault.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('BMW', 'bmw.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('DS오토모빌', 'ds.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('미니', 'mini.png');
INSERT INTO BRAND(BRAND_NAME, BRAND_IMAGE ) VALUES ('테슬라', 'tesla.png');
SELECT * FROM BRAND;
...
INSERT INTO NOTICE (TITLE, CONTENTS, WRITE_DATE ,IS_TOP ) VALUES('중요한 공지사항입니다2.','동자승 렌터카를 이용해주시는 고객여러분께 감사 드립니다. 확인용입니다. ',sysdate, 0);
INSERT INTO NOTICE (TITLE, CONTENTS, WRITE_DATE ,IS_TOP ) VALUES('중요한 공지사항입니다3.','동자승 렌터카를 이용해주시는 고객여러분께 감사 드립니다. 확인용입니다. ',sysdate, 1);
