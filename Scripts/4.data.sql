...
INSERT INTO NOTICE VALUES(5,'고객님께 아래 안내 사항을 공지','동자승 렌터카를 이용해주시는 고객여러분께 감사 드립니다. 시스템 점검 작업으로 인해 아래와 같이 서비스가 일시 중단됨을 알려드립니다. 해당 작업은 상황에 따라서 중단 시간과 범위는 변경될 수 있습니다. 
