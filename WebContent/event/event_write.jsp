...
<div class="contents_box padLeft0">
	<div class="contents">
		...
		<div class="event_content">
			<form action="eventWrite.do" method="post" class="event_write">
				<div>
					<label><input type="checkbox" checked> 사용</label>
					<input type="text" placeholder="제목을 입력해주세요" id="title">
					<input type="text" placeholder="할인" id="sale" class="mt5">
					<div class="file_wrap">
						<p>리스트 이미지</p><input type="file" class="list_file">
						<p>상세페이지 이미지</p><input type="file" class="view_file">
					</div>
				</div>
				...
				<ul class="button_style3 mt50">
					...
					<li><a href="#" class="btn_small btn_case2" id="event_write">확인</a></li>
				</ul>
			</form>
		</div>
	</div>
