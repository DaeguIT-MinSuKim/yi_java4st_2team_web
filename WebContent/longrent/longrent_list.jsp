			...
			<div class="divSearch">
				<form name="frmSearch" method="post" action="pdList.jsp">
					<select name="condition">
						...
						<option value="">제bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb목</option>
					</select> <input type="text" name="keyword" title="검색어 입력"> <input type="submit" value="검색">
				</form>
			</div>
