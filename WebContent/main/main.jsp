			...
			<div class="form_box">
				<form name="main_longrent" action="longRentWriteMain.do" method="get">
					...
					<ul>
						...
						<li class="btn"><input type="submit" onclick="MPopup(); return false;" value="빠른상담 신청하기"></li>
					</ul>
					<p class="privacy"><input type="checkbox" id="checkboxMainLR"><a href="">개인정보 취급방침</a>에 동의합니다.</p>
				</form>
			</div>
		</div>
	</div><!-- //mAdvice -->
